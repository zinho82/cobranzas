...
<div class="container">
    <div class="panel panel-primary">
        <div class="panel-heading"><?php if(isset($_SESSION['campana'])); echo "<b>Campaña: ".$_SESSION['campana']."</b> -" ?> Marcar Pie 0</div>
...
<form enctype="multipart/form-data" class="formulario" id="formulario" method="post">
   ...
   // $objCampana->getArchivoBD_CSV($_POST['archivo'], $ruta.'archivos/', $_POST['numcarga'],";");
    ...
    $objCampana->MarcarCartas($_SESSION['bd'], $_SESSION['tabla'], $_POST['numcarga'], 'juicio','c10');
    ?>
     <?php     endif;?>
    </div>
