...
if($_POST['fecha']){
     ...
     Informes::LlenarArchivo('data_altoriesgo_abcdin','data_altoriesgo_abcdin_datos',str_replace('/', '-', $_POST['fecha']),$fp,'036');
        /////////////////////
     //// base especial
     /////////////////////      
    // Informes::LlenarArchivo('data_especial_abcdin','data_especial_abcdin_datos',str_replace('/', '-', $_POST['fecha']),$fp,'138');
      /////////////////////
     //// base nresto
     /////////////////////
      // Informes::LlenarArchivo('data_nresto_abcdin','data_nresto_abcdin_datos',str_replace('/', '-', $_POST['fecha']),$fp,'091');
       
       /////////////////////
     //// base Nueva
     /////////////////////
     //  Informes::LlenarArchivo('data_nb_abcdin','data_nb_abcdin_datos',str_replace('/', '-', $_POST['fecha']),$fp,'135');
