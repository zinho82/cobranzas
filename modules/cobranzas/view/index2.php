...
<div class="container"> 
    <div class="panel panel-group">
        <div class="panel-success">
            <div class="panel-heading"><?php echo $titulo_llamar_menual;?></div>
            <div class="panel-body">
                <form id="formulario" name="formulario" method="post" action="#">
                    <select name="numdiscar" id="numdiscar">
                <?php  Cobranzas::NumerosDiscar($id_cliente,$_SESSION['bd'], $_SESSION['tabla']);?>
                </select>
                    <?php $agente=explode('/', $_SESSION['usuario']['agente'])?>
                    <input type="hidden" name="agllama" value="<?php echo $agente[1]?>">
                         
                    <input class="btn " type="button" id="llamar" value="Llamar">
