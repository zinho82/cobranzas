<?php
	class Campanas{ 
        ...
        mysql_query($sql,  Config::conectar_db($bd)) or die(mysql_error());
            ...
            public function GuardaAsignacion($ejecutivo,$campana,$carga) {
                ...
                mysql_query($borra,  Config::conectar_db("callcenter"));
            ...
            public function ActivarRegistro($bd,$tabla,$numerodecarga) {
                  $sql="update $bd.$tabla inner join callcenter.temporal on c1=dmacct and numero_de_carga='$numerodecarga' set estado=1 ";
                mysql_query($sql,  Config::conectar_db($bd));
 ...
 ,da.dmppdue=tmp.c55,da.dmppkept=tmp.c57,da.dmppbrok=tmp.c58,da.dmppflag=tmp.c59,da.dmppmade=tmp.c60 ";
            ...
            public function NombreCampana($idcampana){
                ...
                $result=mysql_query($sql,  Config::conectar_db("callcenter")) or die(mysql_error());
